...
const runTest = (version, single_version_view) => {
  ...
  return core.runTestForVersion(logger, docker, version, PROJECT_NAME, TEST_COMMAND, IMAGE_NAME, DIRECTORY_TO_TEST, DOCKERFILE_TEMPLATE, BASE_IMAGE, single_version_view)
}
